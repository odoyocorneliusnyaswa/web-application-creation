document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateOnScroll = function() {
        const elements = document.querySelectorAll('.feature, .program-card, .coach-card, .facility-card, .news-card');
    ...
    const elementsToAnimate = document.querySelectorAll('.feature, .program-card, .coach-card, .facility-card, .news-card');
