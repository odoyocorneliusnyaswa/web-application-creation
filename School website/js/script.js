document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateOnScroll = function() {
        const elements = document.querySelectorAll('.announcement, .link-card, .featured-content, .featured-image');
    ...
    const elementsToAnimate = document.querySelectorAll('.announcement, .link-card, .featured-content, .featured-image');
